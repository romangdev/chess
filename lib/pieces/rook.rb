...
class Rook
  ...
  def generate_moves(current_location, chess_board, rook_color)
    ...
    right_horizontal_moves = handle_right_horizontal_moves(right_horizontal_moves, current_location, rook_color,
                                                           chess_board)
    left_horizontal_moves = handle_left_horizontal_moves(left_horizontal_moves, current_location, rook_color,
                                                         chess_board)

    add_moves_to_main_array(up_vertical_moves, down_vertical_moves, right_horizontal_moves, left_horizontal_moves,
                            moves)
  ...
  def get_rook_direction_moves(chess_board, _location, move_direction, color)
    count = 0
    if color == BLACK_ROOK
  ...
  def handle_up_vertical_moves(up_vertical_moves, current_location, rook_color, chess_board)
    ...
    if rook_color == WHITE_ROOK
      get_rook_direction_moves(chess_board, current_location, up_vertical_moves, BLACK_ROOK)
    else
      get_rook_direction_moves(chess_board, current_location, up_vertical_moves, WHITE_ROOK)
    end
  end
  ...
  def handle_down_vertical_moves(down_vertical_moves, current_location, rook_color, chess_board)
    ...
    if rook_color == WHITE_ROOK
      get_rook_direction_moves(chess_board, current_location, down_vertical_moves, BLACK_ROOK)
    else
      get_rook_direction_moves(chess_board, current_location, down_vertical_moves, WHITE_ROOK)
    end
  end
  ...
  def handle_right_horizontal_moves(right_horizontal_moves, current_location, rook_color, chess_board)
    ...
    if rook_color == WHITE_ROOK
      get_rook_direction_moves(chess_board, current_location, right_horizontal_moves,
                               BLACK_ROOK)
    else
      get_rook_direction_moves(chess_board, current_location, right_horizontal_moves,
                               WHITE_ROOK)
  ...
  def handle_left_horizontal_moves(left_horizontal_moves, current_location, rook_color, chess_board)
    ...
    if rook_color == WHITE_ROOK
      get_rook_direction_moves(chess_board, current_location, left_horizontal_moves, BLACK_ROOK)
    else
      get_rook_direction_moves(chess_board, current_location, left_horizontal_moves, WHITE_ROOK)
    end
  end
end
